      ...
      <ul data-testid="nav" className="nav" onClick={collapseMobileMenu}>
        {isLoggedIn ? (
          <>
            ...
            <li key="historical">
              <NavLink to={"/historical"}>{dictionary.HISTORICAL}</NavLink>
            </li>
            <li key="repository">
              <NavLink to={"/repository"}>{dictionary.REPOSITORY}</NavLink>
            </li>
            <li key="about">
            ...
            <li key="logout">
              <button onClick={onLogout}>{dictionary.BUTTON_LOGOUT}</button>
            </li>
          </>
        ) : (
          <>
            ...
            <li key="signup">
              <NavLink to={"/signup"}>{dictionary.SIGNUP}</NavLink>
            </li>
          </>
        )}
      </ul>
